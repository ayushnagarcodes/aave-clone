...
const ringRevealVariants = {
  hidden: { opacity: 0, scale: 1.25 },
  visible: (value: number) => ({
    opacity: 1,
    scale: 1,
    transition: {
      duration: 1.5 - value * 0.6,
      ease: easeSwift,
      delay: value * 0.4,
    },
  }),
...
function SvgForumBg({ isInView }: SvgForumBgProps) {
  return (
    ...
    >
      {/* Inner ring */}
      <motion.g
        variants={ringRevealVariants}
        custom={0}
        style={{
          transformOrigin: "493.009px 456.991px 0px",
        }}
      >
        <g transform="translate(-493, -457) scale(2)">
          <motion.g
            variants={ringRotateVariants}
            custom={1}
            style={{
              transformOrigin: "493.004px 456.995px 0px",
            }}
          >
            <circle
              cx="24.3086"
      ...
      <motion.g
        variants={ringRevealVariants}
        custom={1}
        style={{ transformOrigin: "493.01px 456.99px 0px" }}
      >
